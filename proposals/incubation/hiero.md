...
![Components of a network](../assets/hiero-structure.svg "Components of a network")
...
The attached file [`dependencies-client-sdks.csv`](../assets/hiero-licenses-sdks.csv) contains a list of all
dependencies of our SDK projects.
Next to that, the attached file [`licenses.csv`](../assets/hiero-licenses.csv) contains an overview of all licenses that
...
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the gRPC Web Proxy that today can be found at https://github.com/hashgraph/hedera-grpcWeb-proxy
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Exchange Rate Tool that today can be found at https://github.com/hashgraph/hedera-exchange-rate-tool
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the SDK TCK that today can be found at https://github.com/hashgraph/hedera-sdk-tck
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Mirror Node Explorer that today can be found at https://github.com/hashgraph/hedera-mirror-node-explorer
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Smart Contracts that today can be found at https://github.com/hashgraph/hedera-smart-contracts
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the JSON RPC Relay that today can be found at https://github.com/hashgraph/hedera-json-rpc-relay
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Local Node that today can be found at https://github.com/hashgraph/hedera-local-node
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Mirror Node that today can be found at https://github.com/hashgraph/hedera-mirror-node
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Consensus Node that today can be found at https://github.com/hashgraph/hedera-services
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the JavaScript SDK that today can be found at https://github.com/hashgraph/hedera-sdk-js
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Swift SDK that today can be found at https://github.com/hashgraph/hedera-sdk-swift
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Rust SDK that today can be found at https://github.com/hashgraph/hedera-sdk-rust
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Java SDK that today can be found at https://github.com/hashgraph/hedera-sdk-java
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Go SDK that today can be found at
  https://github.com/hashgraph/hedera-sdk-go
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the C++ SDK that today can be found at https://github.com/hashgraph/hedera-sdk-cpp
- `https://github.com/hiero-ledger/SUBPROJECT` - This repository contains the Solo CLI that today can be found at
...
Here, the HIP repo should be migrated to https://github.com/hiero-ledger/PROJECT-improvement-proposal.
